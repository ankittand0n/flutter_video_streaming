          ...
          <main className="p-6 pt-6">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-medium transition-colors ${
                    activeTab === 'movies'
                      ...
                      : 'bg-background-2 text-muted hover:bg-accent/20 hover:text-foreground'
                  }`}
                >
                  Movies
                </button>
              ...
              <button
                ...
                className="px-4 py-2 bg-accent text-white rounded-lg font-medium hover:bg-accent-secondary transition-colors"
              >
