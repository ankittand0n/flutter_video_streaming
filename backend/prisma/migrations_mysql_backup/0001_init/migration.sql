-- Migration: 0001_init
-- This migration creates the schema for the flutter_video_streaming database.
-- NOTE: This file intentionally omits CREATE DATABASE / USE statements. Run it
-- against the database specified by your DATABASE_URL.
